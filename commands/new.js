...
export function create(projectName) {
    ...
    dirs.forEach(dir => {
        makeDir(path.join(projectDir, dir))
    })
...
`)
    ...
    // home.html
    writeFile(path.join(projectDir, 'src/app/pages/home/home.html'), `<div class="home">
    <div class="home-card">
    ...
    // home.js
    writeFile(path.join(projectDir, 'src/app/pages/home/home.js'), `// home page
    ...
    // navbar.html
    writeFile(path.join(projectDir, 'src/app/components/navbar/navbar.html'), `<nav id="navbar">
    <a href="#home">Home</a>
</nav>`)
...
#navbar {
    ...
    // navbar.js
    writeFile(path.join(projectDir, 'src/app/components/navbar/navbar.js'), `// navbar component
export function render() {
    return \`
        <nav id="navbar">
        <a href="#home">Home</a>
